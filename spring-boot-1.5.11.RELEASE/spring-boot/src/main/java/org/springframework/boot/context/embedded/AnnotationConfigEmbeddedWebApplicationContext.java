...
public class AnnotationConfigEmbeddedWebApplicationContext
	...
	//主要重写EmbeddedWebApplicationContext的postProcessBeanFactory的方法，，
	//不过其实也是重写AbsractApplicationContext的postProcessBeanFactory，而这个方法会被
	//AbsractApplicationContext的refresh（）方法调用。
	@Override
