...
public class TransactionAdviceConfig {
    ...
    private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.dk.service.*.*(..))";

    @Bean
    public PlatformTransactionManager getPlatformTransactionManager(@Qualifier("anthora") DataSource dataSource){
